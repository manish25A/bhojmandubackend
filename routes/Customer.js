...
router.post(
    ...
    [
        ...
        check('password', 'Password must be alphanumeric') //.isStrongPassword(),
    ],
    function (req, res) {
        ...
        if (!errors.isEmpty()) {
            ...
            bcrypt.hash(password, 10, ((err, hash) => {
                const me = new Product({fName: fName,lName:lName,email:email,mobileNumber:mobileNumber,password:hash});
